...
public interface IServiceBusReceiver : IAsyncDisposable
{
    ...
    Task<IReadOnlyList<ServiceBusReceivedMessage>> PeekMessagesAsync(int maxMessages, long? fromSequenceNumber = null, CancellationToken cancellationToken = default);
