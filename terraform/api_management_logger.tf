resource "azurerm_api_management_named_value" "app_insights_apim_instrumentation_key_named_value" {
  ...
  name                = "evntingest${data.azurerm_application_insights.core.name}-instrumentationkey"
  ...
  display_name = "eventingest${data.azurerm_application_insights.core.name}-instrumentationkey"
