resource "azurerm_key_vault_secret" "repository_api_subscription_secret_primary" {
  name         = format("%s-legacy-api-key-primary", azurerm_api_management_subscription.repository_api_subscription.display_name)
...
resource "azurerm_key_vault_secret" "repository_api_subscription_secret_secondary" {
  name         = format("%s-legacy-api-key-secondary", azurerm_api_management_subscription.repository_api_subscription.display_name)
